...
Our use of the subprocess module to use both arms was succesful, but is somewhat difficult to use. In future, the implementation of multi-threading could be a more optimal solution.
